      ...
      <li>
        ...
        <div class="row mb-4 ">
					<div class="col-xl-12 mx-auto">
						<h6 class="mb-0 text-uppercase">Jadwal kerja pegawai Inovindo</h6>
						<hr/>
						<div class="mb-3 ">
                
				<div class="ms-auto d-flex justify-content-between">
						<div class="btn-group" >
						<a href="ad_tambahjadwal.php">
				<button type="button" class="btn btn-primary px-5 radius-10"><i class='bx bx-message-alt-add'></i>Tambah Jadwal</button></a>
						</div>
				<div>
						...
						<ul class="dropdown-menu dropdown-menu-right dropdown-menu-lg-end">
							<li>
								<a class="dropdown-item" href="ad_jadwal.php?hari=Senin">Senin</a>
							</li>
							<li>
								<a class="dropdown-item" href="ad_jadwal.php?hari=Selasa">Selasa</a>
							</li>
							<li>
								<a class="dropdown-item" href="ad_jadwal.php?hari=Rabu">Rabu</a>
							</li>
							<li>
								<a class="dropdown-item" href="ad_jadwal.php?hari=Kamis">Kamis</a>
							</li>
							<li>
								<a class="dropdown-item" href="ad_jadwal.php?hari=Jumat">Jum'at</a>
							</li>
							<li>
								<a class="dropdown-item" href="ad_jadwal.php?hari=Sabtu">Sabtu</a>
							</li>
						</ul>
							</div>
						</div>
							...
							<div class="card-body">
								<table class="table mb-0 table-striped">
									...
									<tbody>
										<?php
											if(isset($_GET['hari'])){
												tampiljadwalpegawai($_GET['hari']);
											} else{
												tampiljadwalpegawai('senin');
											}
		...
		<div class="col-xl-12 mx-auto">
						<h6 class="mb-0 text-uppercase">Jadwal kerja prakerin Inovindo</h6>
						<hr/>
						<div class="card">
							<div class="card-body">
								<table class="table mb-0 table-striped">
									...
									<tbody>
										<?php
											if(isset($_GET['hari'])){
												tampiljadwalprakerin($_GET['hari']);
											} else{
												tampiljadwalprakerin('senin');
											}
			...
			<!-- <div class="mb-3">
						<div class="col">
							<a href="ad_editjadwal.php"><button type="button" class="btn btn-primary px-5 radius-30"><i class='bx bxs-edit'></i>Edit Jadwal</button></a>
						</div> 
					</div> -->
		</div>
