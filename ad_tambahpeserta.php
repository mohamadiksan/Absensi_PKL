<?php
	...
	if (isset($_POST['tambahprakerin'])) {
		$ni = $_POST['ni'];
		$nama = $_POST['nama'];
		$asal_sekolah = $_POST['asal_sekolah'];
		$program_keahlian = $_POST['program_keahlian'];
		$tgl_mulai = $_POST['tgl_mulai'];
		$durasi_prakerin = $_POST['durasi_prakerin'];
		$password = $_POST['password'];

		tambahprakerin($ni,$nama,$asal_sekolah,$program_keahlian,$tgl_mulai,$durasi_prakerin,$password);
}
?>
<!doctype html>
<html lang="en">
	...
	<div class="wrapper">
		...
		<div class="page-wrapper">
			<div class="page-content">
					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page">Tambah Peserta Prakerin</li>
							</ol>
						</nav>
					</div>
					<!-- <div class="ms-auto">
				...
				<h6 class="mb-0 text-uppercase">Tambah Data Peserta Prakerin Inovindo</h6>
						<hr/>
			<div class="mb-3">
			<div class="col">
					...
					<div class="card-body">
						<div class="border p-4 rounded">
							<div class="card-title d-flex align-items-center">
								...
								<h5 class="mb-0 text-primary">Tambah Peserta Prakerin</h5>
							</div>
							<hr/>
							<div class="row mb-3">
								<label for="inputEnterYourName" class="col-sm-3 col-form-label">Nomor Induk</label>
								<div class="col-sm-9">
									<input type="text" class="form-control" id="inputEnterYourName" placeholder="Nomor Induk" name="ni" required>
								</div>
							</div>
							<div class="row mb-3">
								<label for="inputPhoneNo2" class="col-sm-3 col-form-label">Nama Lengkap</label>
								<div class="col-sm-9">
									<input type="text" class="form-control" id="inputPhoneNo2" placeholder="Nama Lengkap" name="nama" required>
								</div>
							</div>
							<div class="row mb-3">
								<label for="inputEmailAddress2" class="col-sm-3 col-form-label">Institusi</label>
								<div class="col-sm-9">
									<input type="text" class="form-control" id="inputEmailAddress2" placeholder="Institusi" name="asal_sekolah" required>
								</div>
							</div>
							<div class="row mb-3">
								<label for="inputEmailAddress2" class="col-sm-3 col-form-label">Program Keahlian</label>
								<div class="col-sm-9">
									<input type="text" class="form-control" id="inputEmailAddress2" placeholder="Program Keahlian" name="program_keahlian" required>
								</div>
							</div>
							<div class="row mb-3">
								<label for="inputChoosePassword2" class="col-sm-3 col-form-label">Tanggal Mulai Prakerin</label>
								<div class="col-sm-9">
								<input type="date" class="form-control" name="tgl_mulai" required>
								</div>
							</div>
							<div class="row mb-3">
								<label for="inputEmailAddress2" class="col-sm-3 col-form-label">Durasi Prakerin</label>
								<div class="col-sm-9">
									<input type="text" class="form-control" id="inputEmailAddress2" placeholder="Durasi Prakerin (Bulan)" name="durasi_prakerin" required>
								</div>
							</div>
							<div class="row mb-3">
								...
								<div class="col-sm-9 " id="show_hide_password"" style="display: flex;">
									<input type="text" class="form-control" id="inputEmailAddress2" placeholder="Password" name="password" required>
							...
							<div class="row">
								...
								<div class="col-sm-9">
									<button type="submit" class="btn btn-primary px-5 radius-10" name="tambahprakerin"><i class='bx bx-save 1'></i>Simpan</button>
								</div>
							</div>
						</div>
					</div>
