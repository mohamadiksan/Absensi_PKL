    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var data = google.visualization.arrayToDataTable([
          ['Keterangan', 'Jumlah'],
          ['Hadir',     <?php echo rasioabsenpr($_SESSION['id'],"masuk");?>],
          ['Tidak Hadir',      <?php echo rasioabsenpr($_SESSION['id'],"tidak_masuk");?>]
        ]);
				...
				<nav class="navbar navbar-expand">
					...
					<div class="user-box dropdown">
						...
						<ul class="dropdown-menu dropdown-menu-end">
							<li><a class="dropdown-item" href="pr_dashboard.php?logout"><i class='bx bx-log-out-circle'></i><span>Logout</span></a>
							</li>
						</ul>
					</div>
				</nav>
