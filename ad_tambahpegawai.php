<?php
	...
	if (isset($_POST['tambahpegawai'])) {
		...
		tambahpegawai($nip,$nama,$jabatan,$nip,$password);
	}
?>
<!doctype html>
<html lang="en">
	...
	<div class="wrapper">
		...
		<div class="page-wrapper">
			<div class="page-content">
				...
				<h6 class="mb-0 text-uppercase">Tambah Data Pegawai Inovindo</h6>
						<hr/>
			<div class="mb-3">
			<div class="col">
					...
					<div class="card-body">
						<div class="border p-4 rounded">
							<div class="card-title d-flex align-items-center">
								...
								<h5 class="mb-0 text-primary">Tambah Pegawai</h5>
							</div>
							<hr/>
							<div class="row mb-3">
								<label for="inputEnterYourName" class="col-sm-3 col-form-label">NIP</label>
								<div class="col-sm-9">
									<input type="text" class="form-control" id="inputEnterYourName" placeholder="NIP" name="nip" required>
									<!-- <span class="text-light bg-warning p-1 rounded">Silahkan Masukkan NIP Yang Benar</span> -->
								</div>
							</div>
							<div class="row mb-3">
							...
							<div class="row mb-3">
								<label for="inputEmailAddress2" class="col-sm-3 col-form-label">Jabatan</label>
								<div class="col-sm-9">
									<select class="form-control" id="inputEmailAddress2" name="jabatan" required>
										...
										<option value='Analyst System'>Analyst System</option>
							...
							<div class="row mb-3">
								...
								<div class="col-sm-9" id="show_hide_password" style="display: flex;">
									<input type="password" class="form-control border-end-0" id="inputChoosePassword" value="" placeholder="Masukkan Kata Sandi" name="password" required>
							...
							<div class="row">
								...
								<div class="col-sm-9">
									<button type="submit" class="btn btn-primary px-5 radius-10" name="tambahpegawai"><i class='bx bx-save 1'></i>Simpan</button>
								</div>
							</div>
						</div>
					</div>
