				...
				<nav class="navbar navbar-expand">
					...
					<div class="user-box dropdown">
						...
						<ul class="dropdown-menu dropdown-menu-end">
							<li><a class="dropdown-item" href="pr_jadwal.php?logout"><i class='bx bx-log-out-circle'></i><span>Logout</span></a>
							</li>
						</ul>
					</div>
				</nav>
			...
			<div class="page-content">
        		...
        		<div class="row">
					<div class="col-xl-12 mx-auto">
						<h6 class="mb-0 text-uppercase">Jadwal Prakerin Inovindo</h6>
						<hr/>
						<div class="ms-auto mb-3 d-flex justify-content-end">
							<div class="btn-group">
								...
								<ul class="dropdown-menu dropdown-menu-right dropdown-menu-lg-end">
									<li>
										<a class="dropdown-item" href="pr_jadwal.php?hari=Senin">Senin</a>
									</li>
									<li>
										<a class="dropdown-item" href="pr_jadwal.php?hari=Selasa">Selasa</a>
									</li>
									<li>
										<a class="dropdown-item" href="pr_jadwal.php?hari=Rabu">Rabu</a>
									</li>
									<li>
										<a class="dropdown-item" href="pr_jadwal.php?hari=Kamis">Kamis</a>
									</li>
									<li>
										<a class="dropdown-item" href="pr_jadwal.php?hari=Jumat">Jum'at</a>
									</li>
									<li>
										<a class="dropdown-item" href="pr_jadwal.php?hari=Sabtu">Sabtu</a>
									</li>
								</ul>
								</div>
						</div>
							...
							<div class="card-body">
								<table class="table mb-0 table-striped">
									...
									<tbody>
										<?php
											if(isset($_GET['hari'])){
												tampiljadwalhalpr($_GET['hari']);
											} else{
												tampiljadwalhalpr('senin');
											}	
										?>
									</tbody>
								</table>
