	...
	<div class="wrapper">
		...
		<div class="page-wrapper">
			...
			<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page">Detail Peserta Prakerin</li>
							</ol>
						</nav>
					</div>
					<!-- <div class="ms-auto">
				...
				<h6 class="mb-0 text-uppercase">Detail Peserta Prakerin</h6>
						<hr/>
						<div class="mb-3">
			<div class="col">
							...
							<div class="card-body">
								<div class="d-flex align-items-center">
									<div style="width:100%;">
										...
										<?php 
											$sql = "SELECT id_prakerin FROM prakerin where id_user = '".$_GET['id']."';"; 
											$data = mysqli_fetch_assoc(mysqli_query(koneksi(),$sql))['id_prakerin'];
										?>
										<div class="row row-cols-1 row-cols-lg-2 row-cols-xl-3">
											<div class="col">
												<?php 
												if (tampilprakerinpr($data, "foto") != "avatar.png") {
													echo "<img src='foto/".tampilprakerinpr($data, "foto")."' class=\"m-auto mb-5 d-block\" style=\"border-radius: 10px; max-width: 200px;\" alt=\"user avatar\">";
												} else {
											...
											<div class="col">
												...
												<table class="m-auto mb-5 tab">
													...
													<tr>
														...
														<td width="120px">:</td>
														<td><?php echo tampilprakerinpr($data,"id_prakerin") ?></td>
													</tr>
													<tr>
														<td>Nama Lengkap</td>
														<td>:</td>
														<td><?php echo tampilprakerinpr($data,"nama_prakerin") ?></td>
													</tr>
													<tr>
														<td>Tanggal Lahir</td>
														<td>:</td>
														<td><?php 
															if (tampilprakerinpr($data,"tanggal_lahir_prakerin") != '') {
																echo substr(tampilprakerinpr($data,"tanggal_lahir_prakerin"), 8,2)." ".gantibulan(substr(tampilprakerinpr($data,"tanggal_lahir_prakerin"), 5,2))." ".substr(tampilprakerinpr($data,"tanggal_lahir_prakerin"), 0,4);	
															}
														 ?></td>
													</tr>
													<tr>
													...
													<tr>
														...
														<td>:</td>
														<td><?php 
														if (tampilprakerinpr($data,"jk_prakerin") != '') {
															echo tampilprakerinpr($data,"jk_prakerin");
														}
														 ?></td>
													</tr>
													<tr>
														<td>Telepon</td>
														<td>:</td>
														<td><?php echo tampilprakerinpr($data,"telp_prakerin") ?></td>
													</tr>
													<tr>
														<td>Email</td>
														<td>:</td>
														<td><?php echo tampilprakerinpr($data,"email_prakerin") ?></td>
													</tr>
													<tr>
														<td>Alamat</td>
														<td>:</td>
														<td><?php echo tampilprakerinpr($data,"alamat_prakerin") ?></td>
													</tr>
													<tr>
														<td>Agama</td>
														<td>:</td>
														<td><?php echo tampilprakerinpr($data,"agama_prakerin") ?></td>
													</tr>
													<tr>
														<td>Institusi</td>
														<td>:</td>
														<td><?php echo tampilprakerinpr($data,"asal_sekolah") ?></td>
													</tr>
													<tr>
														<td>Program Keahlian</td>
														<td>:</td>
														<td><?php echo tampilprakerinpr($data,"program_keahlian") ?></td>
													</tr>
													<tr>
														<td>Nama Ayah</td>
														<td>:</td>
														<td><?php echo tampilprakerinpr($data,"nama_ayah") ?></td>
													</tr>
													<tr>
														<td>Telp Ayah</td>
														<td>:</td>
														<td><?php echo tampilprakerinpr($data,"telp_ayah") ?></td>
													</tr>
													<tr>
														<td>Nama Ibu</td>
														<td>:</td>
														<td><?php echo tampilprakerinpr($data,"nama_ibu") ?></td>
													</tr>
													<tr>
														<td>Telp Ibu</td>
														<td>:</td>
														<td><?php echo tampilprakerinpr($data,"telp_ibu") ?></td>
													</tr>
													<tr>
														<td>Tanggal Mulai</td>
														<td>:</td>
														<td><?php echo substr(tampilprakerinpr($data,"tanggal_mulai"), 8,2)." ".gantibulan(substr(tampilprakerinpr($data,"tanggal_mulai"), 5,2))." ".substr(tampilprakerinpr($data,"tanggal_mulai"), 0,4); ?></td>
													</tr>
													<tr>
														<td>Durasi</td>
														<td>:</td>
														<td><?php echo tampilprakerinpr($data,"durasi_prakerin")." Bulan"; ?></td>
													</tr>
													<tr>
														<td>Tanggal Selesai</td>
														<td>:</td>
														<td><?php echo substr(tampilprakerinpr($data,"tanggal_selesai"), 8,2)." ".gantibulan(substr(tampilprakerinpr($data,"tanggal_selesai"), 5,2))." ".substr(tampilprakerinpr($data,"tanggal_selesai"), 0,4); ?></td>
													</tr>
													<tr>
														<td>Username</td>
														<td>:</td>
														<td><?php echo tampilprakerinpr($data,"username"); ?></td>
													</tr>
												</table>
											</div>
											<div class="col"></div>
