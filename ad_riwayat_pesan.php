		<?php 
			...
			if (isset($_GET['hapusid'])){
				hapusriwayatpengumuman($_GET['hapusid']);
			}
		?>
		<!doctype html>
		<html lang="en">
						...
						<nav class="navbar navbar-expand">
							...
							<div class="user-box dropdown">
								...
								<ul class="dropdown-menu dropdown-menu-end">
									<li><a class="dropdown-item" href="ad_riwayat_pesan.php?logout"><i class='bx bx-log-out-circle'></i><span>Logout</span></a>
									</li>
								</ul>
							</div>
						</nav>
				...
				<div class="page-wrapper">
					...
					<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
							...
							<div class="ps-3">
								<nav aria-label="breadcrumb">
									<ol class="breadcrumb mb-0 p-0">
										...
										<li class="breadcrumb-item active" aria-current="page">Riwayat Berita</li>
									</ol>
								</nav>
							</div>
							<!-- <div class="ms-auto">
						...
						<div style="display: flex;justify-content: space-between;">
							...
							<h6 class="mb-0 text-uppercase">Riwayat Berita Terkirim</h6>	
							</div>
						</div>
						<hr/>
						<div class="mb-3">
