<?php
	...
	if (isset($_POST['tambahjadwal'])) {
		...
		tambahjadwal($hari,$level,$mulai,$selesai,$kegiatan);
	}
?>
<!doctype html>
<html lang="en">
	...
	<div class="wrapper">
		...
		<div class="page-wrapper">
			<div class="page-content">
				...
				<h6 class="mb-0 text-uppercase">Tambah Jadwal Pegawai/Prakerin Inovindo</h6>
				<hr/>
			<div class="mb-3">
			<div class="col">
					...
					<div class="card-body">
						<div class="border p-4 rounded">
							<div class="card-title d-flex align-items-center">
								<div><i class="bx bx-calendar me-1 font-22 text-primary"></i>
								</div>
								<h5 class="mb-0 text-primary">Tambah Jadwal</h5>
							</div>
							<hr/>
							<div class="row mb-3">
							...
							<label for="inputEmailAddress2" class="col-sm-3 col-form-label">Jam Selesai</label>
								<div class="col-sm-9">
									<input type="time" class="form-control" id="inputEmailAddress2" name="selesai">
								</div>
							</div>
							<div class="row mb-3">
								<label for="inputEmailAddress2" class="col-sm-3 col-form-label">Kegiatan</label>
								<div class="col-sm-9">
									<input type="text" class="form-control" id="inputEmailAddress2" placeholder="Isi Dengan Kegiatan" name="kegiatan">
								</div>
							</div>
							<div class="row">
								<label class="col-sm-3 col-form-label"></label>
								<div class="col-sm-9">
									<button type="submit" class="btn btn-primary px-5 radius-10" name="tambahjadwal"><i class='bx bx-save 1'></i>Simpan</button>
								</div>
							</div>
						</div>
					</div>
